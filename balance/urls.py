...
urlpatterns = [
    ...
    path("income-category-list/", IncomeCategoryListView.as_view(), name="income_category_list"),
    path("income-category-detail/<int:pk>", IncomeCategoryDetailView.as_view(), name="income_category_detail"),
    path("income-category-create/", IncomeCategoryCreateView.as_view(), name="income_category_create"),
    path("income-category-update/<int:pk>", IncomeCategoryUpdateView.as_view(), name="income_category_update"),
    path("income-category-delete/<int:pk>", IncomeCategoryDeleteView.as_view(), name="income_category_delete"),
